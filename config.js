...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "QHlR2LyJ#IYvK3-MQ1K7P5doAmv20AV6Ig1cljl3I937bpYAxfvA",
  // ADD Your Session Id 
  ...
  packname: process.env.packname || "Alone💔😓👈",
  author: process.env.author || "Alone",
  //==========================================- API-CONFIGS -==========================================================
